...
- the call stack operates on a LIFO (Last In, First Out) basis
- But js can achieve non-blocking behaviour through use of event loop, callback queues, and async API.

# Comparison with const, let and var

Feature-------const,-----------let,--------------var
Scope- -------Block-scoped,----Block-scoped------Function-scoped
Hoisting- ----No (tdz),--------No (tdz)----------Yes (initialized as undefined)
...
- this keyword is used to refer to the current object context in which it is used.
...
# ARROW FUNCTIONS = a shorter syntax for writing functions expressions

---

# Lexical 'this' keyword binding in arrow functions

---

<script>
// (1) no binding of this keyword in arrow functions 
...
// (2) no arguments objects in arrow functions
// Normal function
...
// (3) no hoisting in arrow functions
// Normal function
normalFunc()
function normalFunc() {
...
// Output: [ 'learn', 'read', 'code', 'sleep', 'eat', 'exercise' ]
